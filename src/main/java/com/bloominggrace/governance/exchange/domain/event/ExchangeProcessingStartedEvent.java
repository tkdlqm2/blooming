...
public class ExchangeProcessingStartedEvent implements DomainEvent {
    private final ExchangeRequestId exchangeRequestId;
    private final UUID userId;
    private final PointAmount pointAmount;
    private final LocalDateTime occurredOn;

    public ExchangeProcessingStartedEvent(ExchangeRequestId exchangeRequestId, UUID userId, PointAmount pointAmount) {
